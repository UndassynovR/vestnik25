...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1567}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1567}}
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1776}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1899}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% Polymer
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Melt flow rate, g/10 min, T=190ºС
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Melting point, ºС
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Yield strength, MPa
...
% \bottomrule\noalign{}
% \endlastfoot
% 15313-003 & 0,35 & 106 & 10,8 & 14,0 & 450 \\
% \end{longtable}
...
% \endlastfoot
% Carbon & 47,26 \\
% SiO\textsubscript{2} & 50,38 \\
% Na\textsubscript{2}O & 0,04 \\
% MgO & 0,16 \\
% Al\textsubscript{2}O\textsubscript{3} & 0,01 \\
% P\textsubscript{2}O\textsubscript{5} & 0,11 \\
% K\textsubscript{2}O & 1,72 \\
% CaO & 0,28 \\
% TiO\textsubscript{2} & 0,01 \\
% MnO & 0,02 \\
% Fe\textsubscript{2}O\textsubscript{3} & 0,01 \\
% \end{longtable}
