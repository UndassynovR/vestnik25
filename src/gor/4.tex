...
\begin{longtable}[H]{|>{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0554}}|
    >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3599}}|
    >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.5848}}|}
...
144 c. URL: {https://www.dissercat.com}
