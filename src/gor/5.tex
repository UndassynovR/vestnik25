\id{МРНТИ \href{https://grnti.ru/?p1=52&p2=47&p3=15}{52.47.15}}
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9002}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0998}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% \[V_{кор} = \frac{365 \bullet \left( m_{1} - m_{2} \right)}{S \bullet t \bullet \rho},\ мкм/жыл\]
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.0558}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.2962}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1185}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1185}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.0888}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.0741}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1185}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1297}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% Сынама №
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Зертелетін ерітінді
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Пластинаның бастапұы массасы, г
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Тәжірибеден кейінгі пластинаның массасы, г
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Пластинаның беттік ауданы, м\textsuperscript{2},
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Тәжірибе жүргізу уақыты, тәул.
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Болат пластинаның тың тығыздығы, , г/см\textsuperscript{3},
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Коррозия жылдам-дығы, \(
% \)\[V_{кор},\ \]
% 
% \[мкм/жыл\]
% \end{minipage} \\
...
% \endlastfoot
% 1 & 2 & 3 & 4 & 5 & 6 & 7 & 8 \\
% №1 & Тазартылған су & 46,0334 & 45,9817 & 0,325 & 15 & 7,8 & 28,29 \\
% №2 & Тазартылған су +5\% NaCL; & 46,4344 & 46,3879 & 0,0.325 & 15 & 7,8
% & 25,44 \\
% №3 & Тазартылған су +5\% NaCL + сірке қышқылы; & 46,1212 & 45,6328 &
% 0,0.325 & 15 & 7,8 & 267,73 \\
% №4 & Тазартылған су + 5\% NaCL+ сірке қышқылы + 0,5 \% жануар майы; &
% 45,2805 & 45,2389 & 0,0.325 & 15 & 7,8 & 22,76 \\
% №5 & Тазартылған су + 5\% NaCL+ сірке қышқылы + 1,0 \% жануар майы; &
% 45,6406 & 45,5972 & 0,0.325 & 15 & 7,8 & 24,02 \\
% №6 & Тазартылған су + 5\% NaCL+ сірке қышқылы + 1,5 \% жануар майы; &
% 46,2007 & 46,1633 & 0,0.325 & 15 & 7,8 & 20,46 \\
% №7 & Тазартылған су + 5\% NaCL+ сірке қышқылы + 2,0 \% жануар майы; &
% 41,3432 & 41,3111 & 0,0.325 & 15 & 7,8 & 17,56 \\
% \end{longtable}
