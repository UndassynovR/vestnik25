...
\begin{longtable}[H]{|@{}
	...
	>{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1617}}|
	>{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1029}}|
	>{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1471}}|
	>{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1470}}|
	>{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1765}}|@{}}
  \hline
  \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\raggedright
  Тип породы
  \end{minipage}} &
  \multicolumn{2}{|>{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.2794} + 2\tabcolsep}|}{%
...
{\bfseries Таблица 2 - Максимальное перемещение различных нагрузок при
выемке руды}
\begin{longtable}[H]{|@{}
	>{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.0668}}|
	>{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1199}}|
	...
	>{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1744}}|
	>{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.3098}}|@{}}
  \hline
  \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\raggedright
	\hspace{1em}№
  \end{minipage}} &
  ...
  γ = 2.5т/м\textsuperscript{3}
  \end{minipage}} &
  \multicolumn{2}{|>{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.3489} + 2\tabcolsep}|}{%
  \begin{minipage}[b]{\linewidth}\raggedright
  Максимальное перемещение по вертикали в (м) при выемке
  \end{minipage}} &
  \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\raggedright
  Примечание
  \end{minipage}} \\ \cline{4-5}
  & & & \begin{minipage}[b]{\linewidth}\raggedright
  ...
  \endfoot
  \hline
  \hspace{1em}1 & 300 & 750 т/м\textsuperscript{2} & -6,8 & -4,5 & Сильное обрушение
  верних целиков, потеря целостности нижних целиков \\ \hline
  \hspace{1em}2 & 400 & 1000 т/м\textsuperscript{2} & -8,3 & -5,4 & Полное обрушение
  всех целиков \\ \hline
  \hspace{1em}3 & 500 & 1250 т/м\textsuperscript{2} & -9,8 & -6,35 & - \\ \hline
  \hspace{1em}4 & 600 & 1500 т/м\textsuperscript{2} & -11,4 & -7,3 & - \\ \hline
  \end{longtable}
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.0668}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1199}}
...
% \bottomrule\noalign{}
% \endlastfoot
% 1 & 300 & 750 т/м\textsuperscript{2} & -6,8 & -4,5 & Сильное обрушение
