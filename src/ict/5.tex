...
{\bfseries Figure 3 - Encoding scheme}
...
{\bfseries Figure 4 - Feature selection}
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2114}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% Model
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
{\bfseries Table 3 - Iteration of 15 features}
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1733}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2241}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2204}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1706}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2115}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% Model
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1730}}
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1733}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2243}}
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1704}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2115}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% Model
...
% \bottomrule\noalign{}
% \endlastfoot
% SVM & 0.68 & 0.714 & 0.68 & 0.605 \\
% RF & 0.714 & 0.712 & 0.714 & 0.685 \\
% \end{longtable}
...
% \bottomrule\noalign{}
% \endlastfoot
% SVM & 0.67 & 0.698 & 0.67 & 0.584 \\
% RF & 0.705 & 0.702 & 0.705 & 0.673 \\
% \end{longtable}
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1731}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2244}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2202}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1710}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2113}}@{}}
% \toprule\noalign{}
...
% \bottomrule\noalign{}
% \endlastfoot
% SVM & 0.694 & 0.55 & 0.694 & 0.577 \\
% RF & 0.709 & 0.676 & 0.709 & 0.651 \\
% \end{longtable}
