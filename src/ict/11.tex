...
\hline
\multicolumn{3}{|c|}{\textbf{Clustering parameters}} &
  \multicolumn{1}{c|}{\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Number \\ of\\  clusters\end{tabular}}}} &
  \multicolumn{1}{c|}{\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Average \\ silhouette\\  coefficient \\ of all clusters\end{tabular}}}} &
  \multicolumn{1}{c|}{\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Percentage \\ of clusters \\ with silhouette \\ coefficient \\ greater\\  than 0.03\end{tabular}}}} &
  \multicolumn{1}{c|}{\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Percentage \\ of clusters \\ with negative \\ silhouette \\ coefficient\end{tabular}}}} &
  \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Average \\ Calinski-\\ Harabasz \\ index\end{tabular}}} \\ \cline{1-3}
\multicolumn{1}{|c|}{\textbf{Metric}} &
  \multicolumn{1}{c|}{\textbf{Linkage}} &
  \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Distance\_\\  threshold\end{tabular}}} &
  \multicolumn{1}{c|}{} &
  \multicolumn{1}{c|}{} &
  \multicolumn{1}{c|}{} &
  \multicolumn{1}{c|}{} &
