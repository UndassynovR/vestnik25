...
\begin{articleheader}
\sectionwithauthors{M. Zhumazhanova, R.Zhappasova, A.Oryntaeva}{FORMATION OF THE BUSINESS ENVIRONMENT IN KAZAKHSTAN: THE ROLE OF GOVERNMENT SUPPORT FOR ENTREPRENEURSHIP}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.6708}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3285}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0007}}@{}}
\toprule\noalign{}
...
Note: Compiled by the author based on data from https://stat.gov.kz/
{[}6{]}.} \\
\end{longtable}
\begin{multicols}{2}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3337}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3347}}
...
Compiled by the author on the basis of data: https://damu.kz/programmi
{[}7{]}.} \\
\end{longtable}
